...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2025 at 02:16 PM
...
--
ALTER TABLE `employees`
  ADD CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`manager_id`) REFERENCES `managers` (`manager_id`) ON DELETE SET NULL;
